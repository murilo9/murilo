          ...
          <Row className="mt-4">
            ...
            <Col sm={7}>
              ...
              <p className="color-light-gray">
                ...
                na <a href={links.utfpr} className="color-blue" target="_blank">UTFPR</a>.
              </p>
              <p className="color-light-gray">
                Hoje sou formado em Análise e Desenvolvimento de Sistemas 
                pela <a href={links.positivo} className="color-blue" target="_blank">Universidade Positivo.</a>
              </p>
              <h3 className="mb-3 mt-3">💼 
                <span className="ml-1">Experiência profissional</span>
              </h3>
              <p>
                Fui estagiário como Desenvolvedor Web PHP na <a href={links.orbital} className="color-blue" target="_blank">
                Orbital</a> e atualmente 
                sou desenvolvedor web Fullstack no <a href={links.yousendr} className="color-blue" target="_blank">
                YouSendr</a> - utilizando MVC, webpack, VueJS, Vuetify e Element no front-end e Google Apps Script no back-end. 
              </p>
              <h3 className="mb-3 mt-3">🎨 
                <span className="ml-1">O que gosto de fazer</span>
              </h3>
              <p>
              Como entusiasta, gosto de estudar temas relacionados a UI/UX design, eletrônica, 
              robótica e automação com Arduino.
              </p>
            </Col>
          </Row>
        </Container>
